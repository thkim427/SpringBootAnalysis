...
@RestController // ResponseBody를 Meta Annotation으로 가짐
@MyComponent // Spring Container의 컴포넌트임을 선언
public class AnalysisController implements ApplicationContextAware {
    ...
    @GetMapping("/hello") // Class level의 매핑 정보와 함께 Method level의 정보를 제공. hello url의 Post, Delete... 제외한 Get 요청만 받는다.
